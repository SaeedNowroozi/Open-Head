...
public:
    Control_Motor( int spin );
     Control_Motor();
        ...
        void setCurrent1( int current );
        void setMaxSpeed1( int speed );
        void setMinSpeed1( int speed );
        void setAcc1( float acceleration );
        void setDec1( float deceleration );
        void setOverCurrent1( unsigned int ma_current );
        void setThresholdSpeed1( float threshold );
        void setStallCurrent1( float ma_current );

        unsigned long ParamHandler1( BYTE param, unsigned long value );
        void SetLowSpeedOpt1( bool enable );

        void run1( BYTE dir, float spd );
        void Step_Clock1( BYTE dir );

        void goHome1();
        void setAsHome1();

        void goMark1();
        void move1( long n_step );
        void goTo1( long pos );
        void goTo_DIR1( BYTE dir, long pos );
        void goUntil1( BYTE act, BYTE dir, unsigned long spd );

        bool isBusy1();

        void releaseSW1( BYTE act, BYTE dir );

        float getSpeed1();
        long  getPos1();
        void  setMark1();
        void  setMark1( long value );
...
private:
        ...
        void SetParam1( BYTE param, unsigned long value );
        unsigned long GetParam1( BYTE param );

        unsigned long AccCalc1( float stepsPerSecPerSec );
        unsigned long DecCalc1( float stepsPerSecPerSec );
        unsigned long MaxSpdCalc1( float stepsPerSec );
        unsigned long MinSpdCalc1( float stepsPerSec );
        unsigned long FSCalc1( float stepsPerSec );
        unsigned long IntSpdCalc1( float stepsPerSec );
        unsigned long SpdCalc1( float stepsPerSec );
        unsigned long Param1( unsigned long value, BYTE bit_len );
